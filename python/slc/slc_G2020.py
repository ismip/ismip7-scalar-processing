...
def get_slc_af_owv_G2020(H0,H,B0,B,A,c):
  # eq. 2,3 in https://doi.org/10.5194/tc-14-833-2020
  # Note division by RHOSW to get ocean water volume that would be displaced.
  sle_af_owv_ref = get_vaf_G2020(H0,B0,A,c) / c.AO * c.RHOI/c.RHOSW
  sle_af_owv = get_vaf_G2020(H,B,A,c) / c.AO * c.RHOI/c.RHOSW
...
def get_slc_pov_G2020(B0,B,A,c):
...
def get_slc_gr_G2020(H0,H,B0,B,A,c):
  sle_gr_ref = get_vgr_G2020(H0,B0,A,c) / c.AO * c.RHOI/c.RHOSW
  sle_gr = get_vgr_G2020(H,B,A,c) / c.AO * c.RHOI/c.RHOSW
